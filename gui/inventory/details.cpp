...
bool Details::OnMouseEvent(const MouseEvent& event)
{
...
void Details::AddItem(const BAK::InventoryItem& item, BAK::GameState& gameState)
{
...
bool Details::HasMoreInfo(const BAK::InventoryItem& item)
{
...
std::string Details::MakeMoreInfo(const BAK::InventoryItem& item)
{
    std::stringstream ss{};
