    ...
    BAK::ActiveCharIndex dest)
{
            ...
            || item.IsItemType(BAK::ItemType::Staff)))
    {
        ...
        if (dstC.CanSwapItem(item))
        {
            ...
            AudioA::AudioManagerProvider::Get().GetAudioManager().PlaySound(DRAG_SOUND);
        }
        else
        {
    ...
    BAK::ActiveCharIndex character)
{
    ...
    AudioA::AudioManagerProvider::Get().GetAudioManager().PlaySound(BUY_SOUND);
...
void InventoryScreen::UseItem(BAK::InventoryIndex inventoryIndex)
{
    ...
    if (result.mUseSound)
    {
        ...
        {
            AudioA::AudioManagerProvider::Get().GetAudioManager().PlaySound(AudioA::SoundIndex{sound});
        }
    }
