...
void LockScreen::AttemptLock(const InventorySlot& itemSlot)
{
    ...
    if (item.GetItemIndex() == BAK::sPicklock)
    {
        ...
        {
            AudioA::GetAudioManager().PlaySound(sPickedLockSound);
        ...
        else
        {
            ...
            if (BAK::PicklockBroken(skill, lockRating))
            {
                ...
                AudioA::GetAudioManager().PlaySound(sPickBrokeSound);
            }
            else
            {
    ...
    {
        AudioA::GetAudioManager().PlaySound(sUseKeySound);
        if (BAK::TryOpenLockWithKey(item, lockRating))
        {
            AudioA::GetAudioManager().PlaySound(sOpenLockSound);
            // succeeded..
        ...
        else
        {
                ...
                && BAK::KeyBroken(item, skill, lockRating))
            {
                ...
                AudioA::GetAudioManager().PlaySound(sKeyBrokeSound);
            }
            else
            {
