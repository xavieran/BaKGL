...
std::streamsize Console::xsputn(const char_type* s, std::streamsize n)
{
    std::size_t from = 0;
...
Console::int_type Console::overflow(int_type c)
{
...
// Console commands
void Console::ShowTeleports(const std::vector<std::string>& words)
{
    if (!mGameRunner)
    {
...
void Console::NextChapter(const std::vector<std::string>& words)
{
    if (!mGameRunner)
    {
...
void Console::SetComplexEvent(const std::vector<std::string>& words)
{
    if (words.size() < 5)
    {
        std::stringstream ss{};
...
void Console::CastSpell(const std::vector<std::string>& words)
{
    if (words.size() < 3)
    {
        std::stringstream ss{};
...
void Console::SaveGame(const std::vector<std::string>& words)
{
    if (words.size() < 2)
    {
        std::stringstream ss{};
...
void Console::SwitchMidiPlayer(const std::vector<std::string>& words)
{
    ...
    AudioA::GetAudioManager().SwitchMidiPlayer(static_cast<AudioA::MidiPlayer>(midiPlayer));
}
...
void Console::PlayMusic(const std::vector<std::string>& words)
{
    ...
    AudioA::GetAudioManager().ChangeMusicTrack(AudioA::MusicIndex{music_index});
}
...
void Console::PlaySound(const std::vector<std::string>& words)
{
    if (words.size() < 1)
    {
        std::stringstream ss{};
    ...
    AudioA::GetAudioManager().PlaySound(AudioA::SoundIndex{sound_index});
}
...
void Console::RemoveItem(const std::vector<std::string>& words)
{
    if (words.size() < 3)
    {
        std::stringstream ss{};
...
void Console::GiveItem(const std::vector<std::string>& words)
{
    if (words.size() < 3)
    {
        std::stringstream ss{};
...
void Console::DoTeleport(const std::vector<std::string>& words)
{
    if (words.size() < 2)
    {
        std::stringstream ss{};
...
void Console::SetPosition(const std::vector<std::string>& words)
{
    if (words.size() < 3)
    {
        std::stringstream ss{};
...
void Console::SetChapter(const std::vector<std::string>& words)
{
    if (words.size() < 2)
    {
        std::stringstream ss{};
...
void Console::SetLogLevel(const std::vector<std::string>& words)
{
    if (words.size() < 2)
    {
        std::stringstream ss{};
